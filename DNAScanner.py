...
os.makedirs('static/Output/' + output_folder + '/Nucleotide_Concentration/Plots')
...
def ParameterCheck(record_list,n):
    ...
    for record in record_list:
        ...
        for col_val in param_df.columns.values[1:] :
            ...
            fig.write_html('static/Output/' + output_folder + '/Parameters/Plots/'+ col_val + '_' + record.name + '_' + nString +"Nucleotide" + '.html')
    return None
